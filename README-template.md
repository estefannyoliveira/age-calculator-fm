...
Visualize uma idade em anos, meses e dias após enviar uma data válida através do formulário
...
Bônus: Veja os números da idade animarem para o número final quando o formulário for enviado
